...
{
    public partial class DHC_8_400 : UserControl, ISeatMap
    {
        ...
        // ═══════════════════════════════════════════════════════════════════
        // DHC-8-400: Comfort (pnlComfort) and Economy (pnlEconomy) only — no Business cabin
        // ═══════════════════════════════════════════════════════════════════
        ...
        private string ResolveSeatClassFromButton(Button btn)
        {
            ...
            // Last-resort: order by button count (fewer = Comfort, more = Economy)
        ...
        private Panel ResolveCabinPanel(string seatClass)
        {
            foreach (Control c in this.Controls)
            {
                ...
                if (seatClass == "Comfort" && (p.Name == "pnlComfort" || p.Name == "panel1")) return p;
                if (seatClass != "Comfort" && (p.Name == "pnlEconomy" || p.Name == "panel3")) return p;
            }
